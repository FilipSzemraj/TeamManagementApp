    ...
    const createGroup = async () => {
        ...
        try {
            ...
            const chatDocRef = await addDoc(chatRef, {
                createdAt: new Date(), // Aktualna data i czas
                lastMessage: "",
                lastMessageCreatedAt: new Date(), // Aktualna data i czas
                name: groupName, // Nazwa grupy jako nazwa czatu
                participants: selectedFriends, // Uczestnicy grupy
